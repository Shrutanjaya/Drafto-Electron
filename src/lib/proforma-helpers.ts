    ...
    const content = [
        ...
        new Table({
            ...
            rows: [
                ...
                new TableRow({ children: [ new TableCell({children: [para("")], borders: noBorders}), new TableCell({children: [boldLeftPara("(c) Special Category:")], borders: noBorders}), new TableCell({children: [para(proforma.general.specialCategory)], borders: noBorders}) ]}),
        ...
        new Table({
            ...
            borders: noBorders,
            rows: [
                new TableRow({ children: [new TableCell({children: [boldLeftPara("(a) Whether accused/convict has surrendered:")], borders: noBorders}), new TableCell({children: [para(proforma.specialCategories.surrenderStatus === 'Has Surrendered' ? 'Yes' : proforma.specialCategories.surrenderStatus === 'Has Not Surrendered' ? 'No' : 'N.A.')], borders: noBorders})]}),
                createLabelValueRow("(b) FIR No. and Date:", proforma.specialCategories.firNoAndDate),
                ...
                new TableRow({ children: [new TableCell({children: [boldLeftPara("(f) Whether any earlier case between the same parties is filed:")], borders: noBorders}), new TableCell({children: [para(proforma.specialCategories.earlierCaseSameParties)], borders: noBorders})]}),
